...
from Code.Const import C_YELLOW, SCORE_POS, MENU_OPTION, C_WHITE, C_BLACK, C_RED, C_GREEN, C_ORANGE, C_GRAY
...
class Score:
    ...
    def show(self):
        ...
        for player_score in list_score:
            ...
            self.score_text(20, f' {name}    {int(score):05d}    {date}', C_YELLOW, SCORE_POS[list_score.index(player_score)])
        while True:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    pygame.quit()
